...
const SYNASTRY_SECTIONS: { h: string; p: string }[] = [
  { h: '', p: 'Kundli Matching — known as Gun Milan or Ashtakoot Milan — is the classical Vedic method for checking marriage compatibility between two birth charts. It compares the Moon’s position in both charts across eight factors (kootas) worth 36 points (gunas) in total. VedicHour computes it instantly from both birth details with the Swiss Ephemeris.' },
