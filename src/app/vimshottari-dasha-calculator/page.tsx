...
const SECTIONS: { h: string; p: string }[] = [
  { h: '', p: 'Vimshottari Dasha is the timing system at the heart of Jyotish — a 120-year cycle of planetary periods that shows which planet is steering your life at any given moment. This free calculator uses your birth details to find your birth Moon’s nakshatra, then works out the exact Mahadasha and Antardasha you are running now, along with your full timeline.' },
