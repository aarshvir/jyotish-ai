...
const SECTIONS: { h: string; p: string }[] = [
  { h: '', p: 'Your Lagna — also called the ascendant or rising sign — is the zodiac sign climbing over the eastern horizon at the exact moment you were born. This free calculator uses your birth details and the Swiss Ephemeris to find that sign, which becomes the starting point and frame for your entire Vedic chart.' },
...
const FAQS: Faq[] = [
  ...
  { q: 'Is the ascendant the same as the rising sign?', a: 'Yes — ascendant, rising sign and Lagna all refer to the same thing: the sign on the eastern horizon at birth. Vedic astrology usually uses the Sanskrit term Lagna and the sidereal zodiac, while Western astrology says rising sign and uses the tropical zodiac, so the named sign can differ between the two systems.' },
