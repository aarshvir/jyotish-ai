...
const SECTIONS: { h: string; p: string }[] = [
  { h: '', p: 'Manglik Dosha — also called Mangal Dosha or Kuja Dosha — is one of the most-checked factors in Vedic marriage matching. This free calculator uses your exact birth details to find where Mars sits in your chart and whether it forms the dosha, checked from your ascendant, Moon and Venus.' },
