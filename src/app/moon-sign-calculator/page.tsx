...
export const metadata: Metadata = {
  ...
  description:
    'Find your Vedic Moon sign (Rashi / Chandra Rashi) in seconds. Enter your date, time and place of birth to see the sign the Moon occupied at birth, plus your birth star — free, no signup.',
  alternates: { canonical: '/moon-sign-calculator' },
};

const SECTIONS: { h: string; p: string }[] = [
  { h: '', p: 'Your Moon sign — called Rashi or Chandra Rashi in Vedic astrology — is the zodiac sign the Moon occupied at the moment of your birth, measured the Vedic way. This free calculator uses your exact birth details to find that sign precisely, the same Rashi an astrologer uses as the starting point of a reading.' },
  ...
  { h: 'Why your Vedic result can differ from a Western sign', p: 'Vedic astrology measures from where the stars actually sit in the sky, while Western astrology measures from the seasons. The two have drifted about 24 degrees apart over the centuries, so a Vedic placement often falls one sign earlier than the Western one. That is why your Vedic Moon sign here may not match a Sun sign you have seen elsewhere — it is a different zodiac and a different planet, not an error.' },
];

const FAQS: Faq[] = [
  { q: 'What is my Moon sign?', a: 'Your Moon sign (Rashi) is the zodiac sign the Moon occupied at your birth, measured the Vedic way. Enter your date, time and place of birth above and the calculator returns your exact Rashi along with your birth Nakshatra.' },
...
export default function Page() {
  return (
    <CalculatorPage
      ...
      h1Accent="Free"
      intro="Find your Vedic Moon sign in seconds. Enter your birth details and we calculate the exact Rashi the Moon occupied at birth — the sign Jyotish uses for your horoscope and compatibility, explained in plain English with no signup."
      view="moonsign"
      ctaHref="/kundali"
