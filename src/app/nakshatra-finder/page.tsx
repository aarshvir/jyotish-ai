...
const SECTIONS: { h: string; p: string }[] = [
  { h: '', p: 'Your nakshatra, or birth star, is one of the oldest and most personal markers in Vedic astrology. This free finder uses your exact birth details and the Swiss Ephemeris to locate where the Moon sat at the moment you were born, then names your Janma Nakshatra and its pada — the same starting point a Vedic astrologer uses to read your chart.' },
