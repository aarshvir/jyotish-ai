...
const SECTIONS: { h: string; p: string }[] = [
  { h: '', p: 'Sade Sati is the roughly seven-and-a-half-year period when Saturn (Shani) transits the 12th, 1st and 2nd signs counted from your natal Moon. This free calculator uses your exact birth details and Saturn’s live position in the sky to tell you whether Sade Sati is running for you right now and which phase you are in.' },
