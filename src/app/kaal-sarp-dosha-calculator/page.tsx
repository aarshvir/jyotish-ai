...
const SECTIONS: { h: string; p: string }[] = [
  { h: '', p: 'Kaal Sarp Dosha is one of the most talked-about patterns in Vedic astrology, and also one of the most misunderstood. This free calculator uses your exact birth details to check the single thing that defines it: whether all seven classical planets fall on one side of the Rahu–Ketu axis in your chart. You get a clear yes or no, with a plain-English explanation and no fear-mongering.' },
