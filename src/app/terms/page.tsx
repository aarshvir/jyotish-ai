...
const sections = [
  ...
  { title: '2. Description of Service', content: 'VedicHour provides AI-assisted Vedic astrology reports as digital products. Reports include natal chart analysis, hourly forecasts, choghadiya timing, planetary position analysis, and astrological commentary. Astronomical calculations are performed using the Swiss Ephemeris; narrative interpretations are generated by Claude (Anthropic), with OpenAI and Google Gemini as automatic fallbacks. All reports are delivered digitally.' },
