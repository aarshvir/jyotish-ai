    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#6b6350' }}>Create your account</p>
        </div>
        ...
        >
          ...
          <span style={{ fontSize: '12px', color: '#4a4435' }}>or sign up with email</span>
          <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.08)' }} />
        </div>
        ...
        <form onSubmit={(e) => void handleEmailSignup(e)}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            />
            <p style={{ fontSize: '11px', color: '#4a4435', marginTop: '6px', marginBottom: 0 }}>
