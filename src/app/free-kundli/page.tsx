...
const FAQS: Faq[] = [
  ...
  { q: 'How accurate is the chart?', a: 'It uses the Swiss Ephemeris for planetary positions and the sidereal zodiac with the Lahiri ayanamsa — the same standards a traditional Indian astrologer uses. Accuracy depends mostly on how precise your birth time and place are.' },
...
export default function Page() {
  return (
    <CalculatorPage
      ...
      intro="Generate your free Janam Kundali in seconds. Enter your date, time and place of birth and we cast your sidereal chart with the Swiss Ephemeris — showing your Lagna, Moon sign, Nakshatra, Sun sign, current dasha and the Manglik, Kaal Sarpa and Sade Sati flags. No signup, no card."
      view="fullchart"
      ctaHref="/kundali"
