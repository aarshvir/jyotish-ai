...
const FEATURES: { group: string; rows: Array<{ label: string; free: string | boolean; week: string | boolean; month: string | boolean; year: string | boolean }> }[] = [
  {
    ...
    rows: [
      ...
      { label: 'Nativity deep-dive (40-page reading)', free: false, week: false, month: true, year: true },
      { label: 'All 9 grahas with dignities', free: 'summary', week: true, month: true, year: true },
      { label: 'Yogas + scripture citations', free: false, week: 'partial', month: true, year: true },
    ],
  },
  {
    group: 'Daily timing',
  ...
  },
  {
    ...
    rows: [
      { label: '7-day forecast', free: false, week: true, month: true, year: true },
      { label: '30-day complete forecast', free: false, week: false, month: true, year: true },
      { label: '12-month annual Varshaphala', free: false, week: false, month: false, year: true },
      { label: 'Weekly synthesis', free: false, week: false, month: true, year: true },
      { label: 'Monthly theme analysis', free: false, week: false, month: true, year: true },
    ],
  },
  {
    group: 'Exports & access',
    rows: [
      { label: 'PDF report', free: false, week: false, month: true, year: true },
      { label: 'Markdown export', free: false, week: false, month: true, year: true },
      { label: 'Re-generate any time', free: 'unlimited', week: 'within plan', month: 'within plan', year: 'within plan' },
      { label: 'Priority generation queue', free: false, week: false, month: false, year: true },
