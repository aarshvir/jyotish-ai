-- ============================================================
-- VedicHour - Complete Canonical Schema
-- Run this in Supabase SQL Editor on a fresh project.
-- ============================================================

CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- user_profiles: auto-populated by trigger on auth.users insert
...
-- user_consent: legal consent audit trail
...
DROP POLICY IF EXISTS "Service role manages promos" ON promo_usage;
CREATE POLICY "Service role manages promos" ON promo_usage
  FOR ALL USING (auth.role() = 'service_role');
