...
- (THIS IS A PAID AD) asserting or implying a PERSONAL ATTRIBUTE or personal hardship of the viewer — their health, finances, relationship trouble, faith, or emotional state. Meta bans this outright. Examples that BLOCK: "struggling in your marriage?", "feeling lost?", "money problems?", "are you cursed?", "why you keep failing".
  CALIBRATION — THE TEST IS GRAMMATICAL PERSON, NOT SUBJECT MATTER. This rule is about claims the ad makes ABOUT THE VIEWER. It is not a list of forbidden topics, and it is NOT triggered by a story being emotionally heavy.
  Almost every VedicHour ad is a short film: one man, on camera, telling you about his own evening in the FIRST PERSON, in the PAST TENSE. Nothing he says about his own life is an assertion about yours. He is a character. You are watching him.
  BLOCK — the copy turns on the viewer and diagnoses them. Second person, usually a question, usually present tense:
    "struggling in your marriage?" · "feeling lost?" · "money problems?" · "are you cursed?" · "why you keep failing" · "is your career stuck?" · "worried about telling your parents?"
  PASS — a character describes his own life, however painful the subject. ALL of these must PASS:
    "Kal courier aa raha hai. Usse abhi tak nahi bataya." (he lost his job — HIS job)
    "Papa ko aaj bataun ya Saturday?" (he is marrying outside his faith — HIS marriage)
    "Maa ko pehli shaadi ke baare mein kab bataun?" (HIS previous marriage)
    "Ex ka samaan teen hafte se yahin pada hai." · "Offer sign kar diya. Ghar pe abhi tak call nahi kiya."
  These are the conversations this audience actually comes to the product for. Reconciliation, interfaith marriage, telling parents, changing careers, being laid off — that is the market, not a brand risk. A rule that refuses a person having a hard conversation refuses the product itself. It has already killed nine consecutive scripts, so err toward PASS.
  Your job on this clause is exactly four things: OUTCOME PROMISES, FEAR, FORTUNE-TELLING, and JARGON. If the copy is none of those four and the hardship belongs to the man on camera rather than to the viewer, PASS it.` : ''}
