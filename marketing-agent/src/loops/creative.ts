...
THE PERSON IN THE IDEA IS THE MAN WHO WILL SAY IT ON CAMERA. Every reel is performed by ONE recurring brand face — a young Indian man in his late twenties — and he speaks in the FIRST PERSON about his OWN life. That is fixed brand law and you cannot change it, so an idea whose protagonist is a woman cannot be filmed: the writer has to either hand her decision to a man who did not make it, or turn her into a third person the viewer has never met.
That is not theoretical. On 2026-08-19 the idea was "SHE has decided she does not want children and is choosing when to tell her fiance". All six variants collapsed — human eye 34 to 50, the worst batch on record — because the man on camera was left narrating a stranger, and the reviewer kept saying so: "Rhea means nothing to me".
So write HIS decision. The woman in the story is his partner, his mother, his sister, his boss — never the one whose choice the reel is about.
